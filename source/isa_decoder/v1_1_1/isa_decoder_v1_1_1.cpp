                                              ...
                                              const std::unordered_map<std::string, std::string>& pc_to_label_map) const
    {
        ...
        while (is_success && std::getline(inst_stream, inst, kShaderTextDelimiter))
        {
            ...
            if (stream.str().length() == kDwordByte)
            {
                ...
                is_decoded = DecodeInstruction(machine_code_64, instruction_info_bundle, err_message);
            ...
            else if (stream.str().length() > kDwordByte)
            {
                ...
                is_decoded = DecodeInstructionStream(machine_codes_32, instruction_info_stream, err_message);
