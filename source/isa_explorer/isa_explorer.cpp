...
namespace amdisa
{
    namespace explorer
    {
                    ...
                    for (auto& df : spec.data_formats)
                    {
                        ...
                        for (auto& da : df.data_attributes)
                        {
                            ...
                            for (auto& field : da.bit_map)
                            {
                                ...
                                case amdisa::Signedness::kDoesNotApply:
                                    signedness = Signedness::kDoesNotApply;
                                }
        ...
        std::string Spec::GetApiVersion() const noexcept
        {
            return amdisa::explorer::ApiVersion::GetVersion();
        }
