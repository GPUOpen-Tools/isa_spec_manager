...
namespace amdisa
{
    ...
    static const char* kArgOutput       = "output";
    static const char* kArgOutputMsg    = "Path to generated file.";
    static const char  kArgOutput_short = 'o';
    ...
    static const char* kArgDecodeShaderFileMsg    = "Path to shader disassembly file(sp3 / LLVM). Use -o to save output to XML file.";
    ...
    void PublicCliProcessor::AppendOptions(cxxopts::Options& options)
    {
        ...
        xml_out_args << kArgOutput_short << "," << kArgOutput;
        ...
        options.add_options()(help_args.str(), kArgHelpMsg)(xml_in_args.str(), kArgInputXmlMsg, cxxopts::value<std::string>())(
            ...
            xml_out_args.str(), kArgOutputMsg, cxxopts::value<std::string>())(
    ...
    void PublicCliProcessor::Configure(const cxxopts::ParseResult& arguments, const std::string& cli_help_msg, IsaDecoder& spec_api)
    {
        ...
        if (arguments.count(kArgDecodeShaderFile) > 0)
        {
            ...
            if (arguments.count(kArgOutput) > 0)
            {
                output_xml = arguments[kArgOutput].as<std::string>();
            }
            pimpl_->commands.push_back(
                std::make_unique<CliCommandDecodeShaderFile>(shader_file, output_xml, pimpl_->spec_api, branch_target_info));
        }
