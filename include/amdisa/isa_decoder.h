...
namespace amdisa
{
    ...
    enum class FunctionalSubgroups
    {
        ...
        kFunctionalSubgroupMFMA,           // MFMA
        kFunctionalSubgroupWMMA,           // WMMA
     ...
     * GetDebugLog --
     *
     * Retrieves a log of error and warning messages generated by this instance.
     * This function can be used for debugging purposes.
     *
     * Returns a vector of string messages if anything was logged.
     */
